...
const KNOWN_MERCHANTS = [
  ...
  { name: 'Apple One', patterns: [/apple one/i], score: 8, type: 'streaming' },
  ...
  { name: 'Amazon Prime Video', patterns: [/amazon prime/i, /prime video/i, /prime\.com/i], score: 8, type: 'streaming' },
  { name: 'YouTube Premium', patterns: [/youtube.?premium/i, /youtubemusic/i, /youtube.?music/i], score: 8, type: 'streaming' },
  { name: 'YouTube TV', patterns: [/youtube.?tv/i], score: 8, type: 'streaming' },
  { name: 'Twitch', patterns: [/twitch/i], score: 8, type: 'streaming' },
  { name: 'Crunchyroll', patterns: [/crunchyroll/i], score: 8, type: 'streaming' },
  { name: 'Discovery+', patterns: [/discovery\+/i, /discoveryplus/i], score: 8, type: 'streaming' },
  { name: 'AMC+', patterns: [/amc\+/i], score: 8, type: 'streaming' },
  { name: 'BritBox', patterns: [/britbox/i], score: 6, type: 'streaming' },
  { name: 'Acorn TV', patterns: [/acorn.?tv/i], score: 6, type: 'streaming' },
  { name: 'Shudder', patterns: [/shudder/i], score: 6, type: 'streaming' },
  { name: 'Mubi', patterns: [/mubi/i], score: 6, type: 'streaming' },
  { name: 'CuriosityStream', patterns: [/curiosity.?stream/i], score: 6, type: 'streaming' },
  { name: 'Nebula', patterns: [/nebula/i], score: 6, type: 'streaming' },
  { name: 'Dropout', patterns: [/dropout/i], score: 6, type: 'streaming' },
  { name: 'NBA League Pass', patterns: [/nba.?league.?pass/i], score: 6, type: 'streaming' },
  { name: 'NFL Sunday Ticket', patterns: [/nfl.?sunday.?ticket/i], score: 6, type: 'streaming' },
  { name: 'MLB.TV', patterns: [/mlb\.tv/i], score: 6, type: 'streaming' },
  { name: 'F1 TV', patterns: [/f1.?tv/i], score: 6, type: 'streaming' },
  { name: 'WWE Network', patterns: [/wwe.?network/i], score: 6, type: 'streaming' },
  ...
  { name: 'Qobuz', patterns: [/qobuz/i], score: 6, type: 'music' },
  ...
  { name: 'OneDrive', patterns: [/onedrive/i], score: 6, type: 'saas' },
  ...
  { name: 'Monday.com', patterns: [/monday\.com/i, /mondaycom/i], score: 8, type: 'saas' },
  { name: 'ClickUp', patterns: [/clickup/i], score: 8, type: 'saas' },
  { name: 'Basecamp', patterns: [/basecamp/i], score: 6, type: 'saas' },
  ...
  { name: 'Airtable', patterns: [/airtable/i], score: 8, type: 'saas' },
  { name: 'Coda', patterns: [/coda\.io/i], score: 6, type: 'saas' },
  ...
  { name: 'QuickBooks', patterns: [/quickbooks/i, /intuit/i], score: 8, type: 'saas' },
  { name: 'FreshBooks', patterns: [/freshbooks/i], score: 6, type: 'saas' },
  { name: 'Xero', patterns: [/xero/i], score: 6, type: 'saas' },
  { name: 'Wave', patterns: [/wavestrat/i], score: 6, type: 'saas' },
  { name: 'Gusto', patterns: [/gusto/i], score: 6, type: 'saas' },
  { name: 'YNAB', patterns: [/ynab/i, /youneedabudget/i], score: 8, type: 'saas' },
  { name: 'Mint', patterns: [/mint\.com/i], score: 6, type: 'saas' },
  { name: 'Vercel', patterns: [/vercel/i], score: 6, type: 'saas' },
  { name: 'Netlify', patterns: [/netlify/i], score: 6, type: 'saas' },
  ...
  { name: 'Fly.io', patterns: [/fly\.io/i], score: 6, type: 'saas' },
  { name: 'PlanetScale', patterns: [/planetscale/i], score: 6, type: 'saas' },
  { name: 'Neon', patterns: [/neon\.tech/i], score: 6, type: 'saas' },
  { name: 'DataDog', patterns: [/datadog/i], score: 6, type: 'saas' },
  { name: 'Sentry', patterns: [/sentry\.io/i], score: 6, type: 'saas' },
  { name: 'New Relic', patterns: [/new.?relic/i], score: 6, type: 'saas' },
  { name: 'Postman', patterns: [/postman/i], score: 6, type: 'saas' },
  { name: 'JetBrains', patterns: [/jetbrains/i], score: 6, type: 'saas' },
  { name: 'Replit', patterns: [/replit/i], score: 6, type: 'saas' },
  { name: 'Railway', patterns: [/railway\.app/i], score: 6, type: 'saas' },
  ...
  { name: 'Webflow', patterns: [/webflow/i], score: 6, type: 'saas' },
  { name: 'Framer', patterns: [/framer/i], score: 6, type: 'saas' },
  { name: 'Wix', patterns: [/wix/i], score: 6, type: 'saas' },
  ...
  { name: 'LastPass', patterns: [/lastpass/i], score: 6, type: 'saas' },
  ...
  { name: 'Superhuman', patterns: [/superhuman/i], score: 6, type: 'saas' },
  { name: 'Hey', patterns: [/hey\.com/i], score: 6, type: 'saas' },
  { name: 'Fastmail', patterns: [/fastmail/i], score: 6, type: 'saas' },
  { name: 'Cursor', patterns: [/cursor/i], score: 6, type: 'saas' },
  { name: 'Calendly', patterns: [/calendly/i], score: 6, type: 'saas' },
  { name: 'Cal.com', patterns: [/cal\.com/i], score: 6, type: 'saas' },
  { name: 'HoneyBook', patterns: [/honeybook/i], score: 6, type: 'saas' },
  { name: 'Bonsai', patterns: [/bonsai/i], score: 6, type: 'saas' },
  ...
  { name: 'Apple Fitness+', patterns: [/apple.?fitness/i], score: 6, type: 'fitness' },
  { name: 'Fitbit Premium', patterns: [/fitbit/i], score: 6, type: 'fitness' },
  { name: 'Whoop', patterns: [/whoop/i], score: 8, type: 'fitness' },
  { name: 'Oura', patterns: [/oura/i], score: 8, type: 'fitness' },
  { name: 'Zwift', patterns: [/zwift/i], score: 8, type: 'fitness' },
  { name: 'TrainingPeaks', patterns: [/trainingpeaks/i], score: 6, type: 'fitness' },
  { name: 'Lose It!', patterns: [/lose.?it/i], score: 6, type: 'fitness' },
  { name: 'BetterHelp', patterns: [/betterhelp/i], score: 8, type: 'fitness' },
  { name: 'Talkspace', patterns: [/talkspace/i], score: 6, type: 'fitness' },

  // === Storage / Backup ===
  { name: 'Google One', patterns: [/google one/i], score: 8, type: 'storage' },
  { name: 'OneDrive', patterns: [/onedrive/i], score: 6, type: 'storage' },
  { name: 'Dropbox', patterns: [/dropbox/i], score: 8, type: 'storage' },
  ...
  { name: 'Sync.com', patterns: [/sync\.com/i], score: 6, type: 'storage' },
  { name: 'Box', patterns: [/box\.com/i], score: 6, type: 'storage' },
  { name: 'SpiderOak', patterns: [/spideroak/i], score: 6, type: 'storage' },
  { name: 'Tresorit', patterns: [/tresorit/i], score: 6, type: 'storage' },
  ...
  { name: 'Porkbun', patterns: [/porkbun/i], score: 6, type: 'hosting' },
  { name: 'DreamHost', patterns: [/dreamhost/i], score: 6, type: 'hosting' },
  { name: 'SiteGround', patterns: [/siteground/i], score: 6, type: 'hosting' },
  { name: 'WP Engine', patterns: [/wp.?engine/i], score: 6, type: 'hosting' },
  { name: 'Kinsta', patterns: [/kinsta/i], score: 6, type: 'hosting' },
  ...
  { name: 'Bloomberg', patterns: [/bloomberg/i], score: 8, type: 'news' },
  { name: 'Financial Times', patterns: [/financial.?times/i, /ft\.com/i], score: 8, type: 'news' },
  { name: 'The New Yorker', patterns: [/new.?yorker/i], score: 8, type: 'news' },
  { name: 'Wired', patterns: [/wired\.com/i], score: 6, type: 'news' },
  { name: 'The Information', patterns: [/theinformation/i], score: 8, type: 'news' },
  { name: 'Stratechery', patterns: [/stratechery/i], score: 8, type: 'news' },
  { name: 'Apple News+', patterns: [/apple.?news/i], score: 6, type: 'news' },
  { name: 'Morning Brew', patterns: [/morning.?brew/i], score: 6, type: 'news' },
  { name: '1440', patterns: [/1440/i], score: 6, type: 'news' },
];
